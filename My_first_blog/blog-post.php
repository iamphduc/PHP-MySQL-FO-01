...
// Cau lenh truy van bai blog
$query_blog = "SELECT p.*, c.title AS 'category', a.name AS 'author_name' FROM posts p LEFT JOIN categories c ON p.category_id = c.id LEFT JOIN authors a ON p.author_id = a.id WHERE p.status = 1 AND p.id =".$id;
$result_blog = $conn -> query($query_blog);

$blog = $result_blog -> fetch_assoc();

// 5 bai MOST READ moi nhat
$query_mostRead = "SELECT p.*, c.title AS 'category' FROM posts p LEFT JOIN categories c ON p.category_id = c.id WHERE p.status = 1 AND p.category_id = ".$category_id." ORDER BY p.created_at desc limit 5";
			...
			<div id="post-header" class="page-header">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-10">
							<div class="post-meta">
								<a class="post-category cat-2" href="category.php"><?= $blog['category']?></a>
					...
					<div class="col-md-8">
						<div class="section-row sticky-container">
							<div class="main-post">
								...
								<p><?= $blog['content']?></p>
								<p><strong><em>Đăng bởi: <?= $blog['author_name']?></em></strong></p>
							</div>
					...
					<div class="col-md-4">
						...
						<div class="aside-widget">
							...
							<div class="post post-widget">
								<a class="post-img" href="blog-post.html"><img src="img/<?= $mostRead['thumbnail']?>" alt=""></a>
								<div class="post-body">
